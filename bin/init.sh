...
ISTIO_ENVOY_BASE_URL="${ISTIO_ENVOY_BASE_URL:-https://pub-eb362987fc11449aa70e8645526a52a7.r2.dev/proxy}"

# If we are not using the default, assume its private and we need to authenticate
if [[ "${ISTIO_ENVOY_BASE_URL}" != "https://storage.googleapis.com/istio-build/proxy" && "${ISTIO_ENVOY_BASE_URL}" != "https://pub-eb362987fc11449aa70e8645526a52a7.r2.dev/proxy" ]]; then
